...
module.exports.execute = async(client, message, args, ayar, emoji) => {
  ...
  let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("SAVARONA ❤️ PAİ").setColor(client.randomColor()).setTimestamp();
